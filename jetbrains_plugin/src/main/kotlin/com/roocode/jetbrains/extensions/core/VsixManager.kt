...
import com.roocode.jetbrains.theme.ThemeManager.Companion.getThemeResourceDir
...
class VsixManager {
    ...
    private fun getPluginThemesDirectory(): File? {
        return try {
            ...
            val pluginThemesPath = com.roocode.jetbrains.util.PluginResourceUtil.getResourcePath(
    ...
    fun getExtensionResourcePath(
        ...
        try {
            val pluginPath = com.roocode.jetbrains.util.PluginResourceUtil.getResourcePath(
                com.roocode.jetbrains.util.PluginConstants.PLUGIN_ID,
                codeDir
            )
